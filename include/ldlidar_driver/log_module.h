...
private:
    ...
    #else
        #define LOG_DEBUG_LITE(format, ...) \
            do                              \
            {                               \
            } while (0)
        #define LOG_INFO_LITE(format, ...) \
            do                             \
            {                              \
            } while (0)
        #define LOG_WARN_LITE(format, ...) \
            do                             \
            {                              \
            } while (0)
        #define LOG_ERROR_LITE(format, ...) \
            do                              \
            {                               \
            } while (0)
    #endif
    ...
    #else
        #define LOG_DEBUG_PRINT(format, ...) \
            do                               \
            {                                \
            } while (0)
        #define LOG_INFO_PRINT(format, ...) \
            do                              \
            {                               \
            } while (0)
    #endif
