...
namespace ldlidar
{
    ...
    LdLidarProtocol::LdLidarProtocol()
    {
    }
    ...
    uint8_t LdLidarProtocol::AnalysisDataPacket(uint8_t byte)
    {
        static enum {
            HEADER,
            VER_LEN,
    ...
    LiDARMeasureDataType& LdLidarProtocol::GetPCDPacketData(void)
    {
        return pcdpkg_data_;
    }

    LiDARHealthInfoType& LdLidarProtocol::GetHealthPacketData(void)
    {
        return healthpkg_data_;
    }

    LiDARManufactureInfoType& LdLidarProtocol::GetManufactureInfoPacketData(void)
    {
